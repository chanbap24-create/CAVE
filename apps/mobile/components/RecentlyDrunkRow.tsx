...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    backgroundColor: '#FFF6EC', borderRadius: 16, overflow: 'hidden',
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 16,
    elevation: 3,
  },
  imgWrap: { position: 'relative', backgroundColor: '#FFE5D9' },
  img: { width: '100%', height: 140 },
  imgPlaceholder: { backgroundColor: '#FFE5D9' },
  ratingBadge: {
    position: 'absolute', left: 8, top: 8,
    flexDirection: 'row', backgroundColor: '#FFC93C',
    paddingHorizontal: 8, paddingVertical: 3, borderRadius: 999, gap: 2,
  },
  starIcon: { fontSize: 10, color: '#2D1B1B' },
  ratingText: { fontSize: 10, fontWeight: '800', color: '#2D1B1B', marginLeft: 2 },

  body: { padding: 12 },
  wineName: { fontSize: 13, fontWeight: '700', color: '#2D1B1B', lineHeight: 18 },
  when: { fontSize: 11, color: '#8A7868', marginTop: 4 },
  note: { fontSize: 11, color: '#5A4A3A', marginTop: 6, lineHeight: 16 },
